...
- `list-opencode` and `import-opencode` default to top-level OpenCode sessions only, which matches the smaller visible set in OpenCode. Add `--all-sessions` to include child/subagent sessions.
